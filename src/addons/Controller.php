...
class Controller extends \think\Controller
{
    ...
    public function __construct(Request $request = null)
    {
        ...
        $dispatchParam = $dispatch->getParam();

        if (isset($dispatchParam['addon']))
        {
            $addon = strtolower($dispatchParam['addon']);
            $controller = strtolower($dispatchParam['controller']);
            $action = strtolower($dispatchParam['action']);
        }
        else
        {
